...
|                                   | reportdate   |string| Date the report was requested, based on time zone of the user. The value is returned in Lucky Monaco’s server time zone (UTC/GMT+0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Required |
