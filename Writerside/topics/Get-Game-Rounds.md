...
|                                   | dateTime     | datetime  | Date and time when the round was played, based on time zone of the user. The value is returned in Kyren’s server time zone (UTC/GMT+0).                                                                                                                                                                                                                                                                                                                                                                                                                                                | Required |
...
|                                   | uerId        |  string   | Unique id for player on the Kyren side.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Required |
