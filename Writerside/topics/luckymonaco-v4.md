...
| Userinformation       | This method get information about a specific user on Lucky Monaco side.                                                                        | Optional |
| GetBalance            | this method Operator can get the current balance of the player in the Lucky Monaco                                                             | Optional |
| GetTransferstatus     | This method returns the status of a particular transaction that transferred the money in or out the player’s balance on the Lucky Monaco side. | Optional |
