...
This is a simple API for Casino Operator to retrieve some data from Kyren system and send some events to
Kyren.
...
URL of the HTTP service will be provided by Kyren team member for the Stage and production environments and looks
like : 
...
2. Run "Get Casino Icon Info" to get the information about the icon size and language provided. (If you need icons in other sizes, please contact the Kyren team.)
