...
Lucky Monaco. API is an HTTP listener, which listens POST requests coming to an URL with the request mappings below.
...
- proper IPs are supplied to Lucky Monaco for whitelistingStart typing here...