...
Important : This is executed when the game is abnormally disconnected, the user does not check the results of the game within max **24 hours**, and fails to end the round.<br/> This status is marked as CompleteInProcess. <br/>
...
``` json
{
    ...
    "currency": "USD",
    "amount": 10.0,
    "roundDetails": {"type": "result","desc":[{"banker":20},{"playerpair":11}]},
    "roundId" : "5103188801",
