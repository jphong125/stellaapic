...
* Partner ID (used for secureLogin) and Token will be issued by Kyren team member.
...
Kyren API provides interfaces that allow you to use information of operator's existing players in Kyren system.

Game Opening with logged in player for inviting into Kyren, and you can start an integration between Player's and Partner's Game Money.
