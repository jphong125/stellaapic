...
This is a simple API for game Operator to connect to the Kyren game system. API is an HTTP listener, which listens
...
URL of the HTTP service will be provided by Kyren for the production and test environments and looks
like: https:/{API service domain}/IntegrationService/CasinoGameAPI
