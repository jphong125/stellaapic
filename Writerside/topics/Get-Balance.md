...
## Overview
Using this method Operator can get the current balance of the player in the Kyren.
...
| Name        |Data Type| Description                                            | Remark  |
|:------------|:---:|:-------------------------------------------------------|---|
| balance     |string| Current user’s balance within the Kyren system. |  Required |
