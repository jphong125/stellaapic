# Session Expired T (Reserved for future development)
...
The method is optional and is not sent to the Casino Operator by default.<br/> In case Casino Operator needs this method to be
